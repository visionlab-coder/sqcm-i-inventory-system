...
import { runOperationsActivationApprovalToOrchestratorRehearsal } from '../src/operations/operations-activation-approval-to-orchestrator-rehearsal.mjs';

const projectRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');
const activationBundleSha256 = computeOperationsActivationBundleSha256(projectRoot);
const result = runOperationsActivationApprovalToOrchestratorRehearsal({ activationBundleSha256 });
