...
function verify() {
  ...
  const commandSets = {
    ...
    'P6/P6-G4-PRODUCTION-DNS-TLS-CUTOVER-AND-SIGNOFF': [
      ...
      ['production-signoff-actual-evidence', 'npm.cmd', ['run', 'production:signoff-actual-evidence']],
      ...
      ['operations-activation-approval-preflight', 'npm.cmd', ['run', 'operations:activation-approval-preflight']],
      ['operations-activation-approval-pipeline-rehearsal', 'npm.cmd', ['run', 'operations:activation-approval-pipeline-rehearsal']],
      ['operations-activation-approval-to-orchestrator-rehearsal', 'npm.cmd', ['run', 'operations:activation-approval-to-orchestrator-rehearsal']],
      ['operations-activation-full-sequence-rehearsal', 'npm.cmd', ['run', 'operations:activation-full-sequence-rehearsal']],
      ['operations-activation-wait-resume-sequence-rehearsal', 'npm.cmd', ['run', 'operations:activation-wait-resume-sequence-rehearsal']],
      ['operations-activation-three-failure-matrix-rehearsal', 'npm.cmd', ['run', 'operations:activation-three-failure-matrix-rehearsal']],
      ['operations-activation-process-runner-rehearsal', 'npm.cmd', ['run', 'operations:activation-process-runner-rehearsal']],
      ['operations-activation-signoff-lifecycle-rehearsal', 'npm.cmd', ['run', 'operations:activation-signoff-lifecycle-rehearsal']],
      ...
      ['operations-alert-delivery-runner', 'npm.cmd', ['run', 'operations:alert-delivery-runner']],
      ['operations-alerting-evidence', 'npm.cmd', ['run', 'operations:alerting-evidence']],
      ['operations-backup-restore-runner', 'npm.cmd', ['run', 'operations:backup-restore-runner']],
      ['operations-backup-restore-evidence', 'npm.cmd', ['run', 'operations:backup-restore-evidence']],
      ['operations-certificate-observer', 'npm.cmd', ['run', 'operations:certificate-observer']],
      ['operations-certificate-evidence', 'npm.cmd', ['run', 'operations:certificate-evidence']],
      ['operations-oncall-drill-runner', 'npm.cmd', ['run', 'operations:oncall-drill-runner']],
      ['operations-oncall-evidence', 'npm.cmd', ['run', 'operations:oncall-evidence']],
      ['operations-maintenance-runner', 'npm.cmd', ['run', 'operations:maintenance-runner']],
      ['operations-maintenance-evidence', 'npm.cmd', ['run', 'operations:maintenance-evidence']],
      ['operations-improvement-queue-collector', 'npm.cmd', ['run', 'operations:improvement-queue-collector']],
      ['operations-improvement-queue-evidence', 'npm.cmd', ['run', 'operations:improvement-queue-evidence']],
      ['operations-signoff-input-assembler', 'npm.cmd', ['run', 'operations:signoff-input-assembler']],
