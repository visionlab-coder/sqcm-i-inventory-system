...
const output = {
  ...
  requiredEnvironment: resumeSignoff
    ? ['PRODUCTION_CUTOVER_RUN_ID', 'PRODUCTION_CUTOVER_SIGNOFF_CHECKPOINT_FILE', 'PRODUCTION_CUTOVER_SIGNOFF_RESUME_CONFIRMATION', 'PRODUCTION_CUTOVER_EVIDENCE_ASSEMBLY_CONFIRMATION', 'PRODUCTION_UAT_ADMIN_RESULT_FILE', 'PRODUCTION_UAT_MANAGER_RESULT_FILE', 'PRODUCTION_UAT_USER_RESULT_FILE', 'PRODUCTION_BUSINESS_SIGNOFF_FILE', 'PRODUCTION_SECURITY_SIGNOFF_FILE', 'PRODUCTION_OPERATIONS_SIGNOFF_FILE', 'PRODUCTION_CUTOVER_ACTUAL_EVIDENCE_FILE']
    : ['PRODUCTION_CUTOVER_CONFIRMATION'],
