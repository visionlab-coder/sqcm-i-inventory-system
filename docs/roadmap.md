...
- 가속 Packet: **ACC-P7-02-OPERATIONS-ACTIVATION-AND-SIGNOFF**. P7 운영 인수 preflight는 SLO·경보·백업·복원·인증서·온콜·정기점검·개선 큐 8개 영역 계약 오류 0과 회귀 4/4로 준비됐다. 실제 활성화는 P6 G4 완료와 운영 증거 12개 이후에만 허용하며 P7 상태는 미착수로 유지한다.
