...
| P7 운영·유지보수 활성화 | 백업, 경보, 온콜, 정기 점검, 개선 큐 | ⏳ 미착수 | 운영 백업·경보 수신·복구훈련과 책임자 인수 | 운영 8영역과 책임자 서명 actual evidence compiler 준비 완료. 실제 활성화는 P6 완료 후 시작 |
